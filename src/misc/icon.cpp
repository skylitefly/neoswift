    ...
    const CSequence<CIcon> &CIcon::allIcons()
    {
        ...
        static const CSequence<CIcon> icons(
            { CIcon(CIcons::ApplicationAircraft, "aircraft"),
              ...
              CIcon(CIcons::SwiftCore16, "neoswift core"),
              CIcon(CIcons::SwiftCore24, "neoswift core"),
              CIcon(CIcons::SwiftCore48, "neoswift core"),
              CIcon(CIcons::SwiftCore64, "neoswift core"),
              CIcon(CIcons::SwiftCore128, "neoswift core"),
              CIcon(CIcons::SwiftCore256, "neoswift core"),
              CIcon(CIcons::SwiftCore512, "neoswift core"),
              CIcon(CIcons::SwiftCore1024, "neoswift core"),
              CIcon(CIcons::SwiftLauncher16, "neoswift launcher"),
              CIcon(CIcons::SwiftLauncher24, "neoswift launcher"),
              CIcon(CIcons::SwiftLauncher48, "neoswift launcher"),
              CIcon(CIcons::SwiftLauncher64, "neoswift launcher"),
              CIcon(CIcons::SwiftLauncher128, "neoswift launcher"),
              CIcon(CIcons::SwiftLauncher256, "neoswift launcher"),
              CIcon(CIcons::SwiftLauncher512, "neoswift launcher"),
              CIcon(CIcons::SwiftLauncher1024, "neoswift launcher") });
        return icons;
    }
